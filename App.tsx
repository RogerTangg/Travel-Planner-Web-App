    ...
    <div className="flex h-screen w-full bg-gray-50 text-warm-800 font-sans overflow-hidden">
      ...
      <div className="w-[320px] flex-shrink-0 bg-white border-r border-gray-200 flex flex-col z-20 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        ...
        <div className="p-3 border-b border-gray-100">
          <form onSubmit={handleAddSpot} className="relative mb-2">
            ...
            <div className="relative mb-1.5">
              <input 
                ...
                className={`w-full pl-10 pr-4 py-3 bg-gray-50 border-2 rounded-xl text-sm focus:bg-white focus:ring-2 outline-none transition-all ${isManualMode ? 'border-amber-300 focus:ring-amber-200 focus:border-amber-400' : 'border-gray-200 focus:ring-sakura-200 focus:border-sakura-300'}`}
              />
            ...
            <div className="flex gap-1.5">
              <button 
                ...
                className={`flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg shadow-sm hover:shadow-md border-2 disabled:opacity-50 font-medium transition-all ${isManualMode ? 'bg-amber-50 text-amber-600 border-amber-200 hover:bg-amber-100' : 'bg-sakura-50 text-sakura-600 border-sakura-200 hover:bg-sakura-100'}`}
              >
              ...
              <button 
                ...
                className={`px-2.5 py-2 rounded-lg shadow-sm hover:shadow border-2 transition-all ${isManualMode ? 'bg-amber-100 text-amber-600 border-amber-300' : 'bg-white text-gray-400 hover:text-amber-500 border-gray-200 hover:border-amber-200'}`}
              >
                <PenLine size={16} />
              </button>
              ...
              <div className="relative">
                ...
                >
                  {isAnalyzing && !newSpotName ? <div className="animate-spin h-3.5 w-3.5 border-2 border-sakura-500 border-t-transparent rounded-full"/> : <Upload size={16} />}
                </button>
              </div>
            </div>
          </form>
